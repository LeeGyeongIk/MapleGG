...
#     driver.execute_script('$("#selectGrade select").val(4)')

#     driver.find_element_by_xpath('//*[@id="selectPartsType"]/a')
#     driver.execute_script('$("#selectPartsType select").val(1)')

#     driver.find_element_by_xpath('//*[@id="lv"]').send_keys("200")
